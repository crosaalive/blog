...
<div>
	...
	<div class="right">
		<script>
    function del(id){
        if(confirm("确定删除此导航菜单吗")){  
          $.ajax({
              type: "POST",
              url: "/xblog/index.php/Admin/Nav/delNav",
              data: 'id='+id,
...
<div class="nav">
<a href="/xblog/index.php/Admin/Nav/addNav">添加导航菜单</a>
       ...
       <td><?php echo ($v['sort']); ?></td>
        <td>
        	<!-- <a href="<?php echo U('Admin/Category/form');?>">添加子类</a>  |  -->
        	 <a href="<?php echo U('Admin/Nav/editNav',array('id'=>$v['nid']));?>">修改</a> | 
          <button class="btn btn-xs" type="button" onclick="del('<?php echo ($v['nid']); ?>')">删除</button>
        </td>
