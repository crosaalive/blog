...
<div>
    ...
    function del(aid){
        ...
        if(confirm("确定删除此文章吗")){  
          $.ajax({
              type: "POST",
              url: "/index.php/Admin/Article/delArticle",
              data: 'a_id='+id,
...
<div  class="cat_list">
<ul>
	<li> <button class="btn " type="button"><a href="<?php echo U('Admin/Article/index');?>">文章列表</a></button> </li>
	<li> <button class="btn " type="button"><a href="<?php echo U('Admin/Article/addArticle');?>">添加文章</a></button> </li>
</ul>
<br><br><br>
