...
function del(aid){
        ...
        if(confirm("确定删除此规则吗")){  
          $.ajax({
              type: "POST",
              url: "/xblog/index.php/Admin/AuthManager/delRule",
              data: 'id='+id,
...
<br>
<br>
<p><a href="/xblog/index.php/Admin/AuthManager/addRuleForm/" style="margin:50px;padding:10px;font-size:14px;border:1px solid gray;">添加规则</a></p>
