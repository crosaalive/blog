...
<body>
	...
	<div class="content">
		<div class="content_l">
			<div class="slide">
					<li><a href=""><img src="/Public/images/a1.gif" alt=""></a></li>
					<li><a href=""><img src="/Public/images/a2.gif" alt=""></a></li>
					<li><a href=""><i<!-- mg src="/Public/images/a1.gif" alt=""></a></li> -->
			</div>
			<br>
			<div class="clear"></div>
		...
		<?php if(is_array($article)): foreach($article as $key=>$arti): ?><div class="article">
				...
				<div class="detail">
					<div>
							<li> <h3><?php echo ($arti['title']); ?></h3> </li>

							<li class="detail_a"><?php echo html_entity_decode($arti['content']); ?></li>

							<li><span>分类</span><span>时间 <?php echo (date('Y-m-d h',$v['created'])); ?></span>
...
<div class="middle"></div>	
		<div class="content_r">
			...
			<div class="focus">
				<h3>关注我</h3>
				<ul>
					<li><a href=""><img src="/Public/images/xl.jpg" alt="联系邮箱"></a></li>
					<li><a href=""><img src="/Public/images/yx.jpg" alt="QQ群讨论"></a></li>
					<li><a href="https://github.com/"><img src="/Public/images/img03.gif" alt="联系邮箱"></a></li>
				</ul>
			</div>
			<!-- 关注我结束 -->
			<!-- ad_1 -->
			<div class="banner_1"><img src="/Public/images/ad_1.jpg" alt=""></div>
			<!-- 栏目导航 -->
					<div class="cat_title"><h3>栏目导航</h3></div>

					<div class="category">
							<li>
							<?php if(is_array($cat)): foreach($cat as $key=>$cate): ?><li><a href="#"><?php echo ($cate['cat_name']); ?></a></li><?php endforeach; endif; ?>
							</li>
					</div>
			</div>
			<!-- ad_2 -->
			<div class="banner_2">
				<p><img src="/Public/images/ad002.gif" alt=""></p>
			</div>
			...
			<div class="hot_list">
				...
				<?php if(is_array($hot)): foreach($hot as $key=>$h): ?><li><a href="#">
					<?php echo $h['title']; ?>
					</a></li><?php endforeach; endif; ?>
			</div>
			<!-- ad_3 -->
			<div class="banner_3">
				<a href=""><img src="/Public/images/a004.gif" alt=""></a>
			</div>
			<!-- 友情链接 -->
			<div class="link">
				<h3>
